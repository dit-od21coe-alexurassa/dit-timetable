...
class Timetable(models.Model):
    ...
    intake_stream = models.ForeignKey(to=IntakeStream, on_delete=models.SET_NULL, null=True)
    academic_year = models.ForeignKey(to=AcademicYear, on_delete=models.SET_NULL, null=True)
